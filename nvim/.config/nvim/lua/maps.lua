...
map('n', '<space>rr', ':lua vim.lsp.buf.rename()<CR>')
map('n', 'gr', ':lua vim.lsp.buf.references()<CR>')
map('n', '<space>s', ':lua vim.lsp.buf.document_symbol()<CR>')
map('n', '<space>e', ':lua vim.lsp.diagnostic.show_line_diagnostics()<CR>')
