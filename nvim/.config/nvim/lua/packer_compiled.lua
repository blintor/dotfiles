...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-treesitter', 'FixCursorHold.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'nvim-cmp', 'null-ls.nvim', 'neoscroll.nvim', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
