...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'nvim-lspconfig', 'nvim-colorizer.lua', 'FixCursorHold.nvim', 'Comment.nvim', 'neoscroll.nvim', 'nvim-treesitter', 'lspsaga.nvim', 'nvim-lsp-installer', 'gitsigns.nvim', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
